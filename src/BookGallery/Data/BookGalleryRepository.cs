...
namespace BookGallery.Data
{
    ...
    {
        private static List<BookGalleryItem> _comicBooks = new List<BookGalleryItem>
        {
                new BookGalleryItem()
                {
        ...
        public BookGalleryItem GetBookGalleryItem(int id)
        {
            return _comicBooks.FirstOrDefault(x => x.Id == id);
        }

        public List<BookGalleryItem> GetBookGalleryItems()
        {
            return _comicBooks;
        }
    }
